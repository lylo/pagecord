...
Every comment is checked for spam before it reaches your queue, so most of it never appears at all. Anything that gets through is still held for approval, and you can delete it.
