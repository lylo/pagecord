...
Every Pagecord account gets a unique delivery email address. You'll find it in **Settings**. It looks something like `myblog_abc123@post.pagecord.com`.
...
```javascript
Just visited Tokyo for the first time!
