...
class PostsMailboxTest < ActionMailbox::TestCase
  ...
  test "should correctly store blank subject, non-blank HTML message body" do
    ...
    assert_equal "<div>Ok, I caved. Pagecord now tentatively supports images. All you need to do is include a link to an image and it <s>will</s> should be <u>automatically</u> unfurled. Here's hoping...<br></div><div><br></div><div><a href=\"https://google.com\">https://google.com</a></div>", format_html(user.posts.last.content.to_s.strip)
  end
