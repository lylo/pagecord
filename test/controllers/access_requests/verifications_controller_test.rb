...
class AccessRequests::VerificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not verify expired access request" do
    ...
    get access_request_verification_url(access_requests(:elliot_expired).token_digest)
  ...
  test "should not verify access request with invalid token" do
    get access_request_verification_url("invalid")
