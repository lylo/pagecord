...
class App::Settings::Subscriptions::PlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not allow switching from a yearly plan to monthly" do
    ...
    patch app_settings_subscriptions_plan_path(plan: "monthly")
  ...
  test "should change plan from monthly to annual with immediate proration" do
    ...
    patch app_settings_subscriptions_plan_path(plan: "annual")
  ...
  test "should upgrade from annual to supporter with immediate proration" do
    ...
    patch app_settings_subscriptions_plan_path(plan: "supporter")
  ...
  test "should reject invalid plan" do
    patch app_settings_subscriptions_plan_path(plan: "invalid")
