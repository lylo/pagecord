...
class Html::StripAttachmentChildrenTest < ActiveSupport::TestCase
  test "strips figure children from gallery attachments" do
    ...
    result = Html::StripAttachmentChildren.new.transform(input)
  ...
  test "strips figure children from standalone attachments" do
  ...
  test "returns html unchanged when no attachments present" do
    input = "<p>Hello world</p>"
    assert_equal input, Html::StripAttachmentChildren.new.transform(input)
  end
end
