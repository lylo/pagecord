...
- **Concerns not service obejcts**: Prefer concerns for shared model/controller behaviour, keeping models slim.
...
### CSS & Styling
- **Tailwind CSS**: Use Tailwind utility classes for styling in the /app namespace.
...
- **Human revew**: Ask for human review before committing code generated by Claude
