module Billing
  module Paddle
    class PaymentMethodTransactionsController < App::BaseController
      # Paddle requires a fresh transaction before the customer can update their
      # payment method. See https://developer.paddle.com/build/subscriptions/update-payment-details
      def create
