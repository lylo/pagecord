class SocialNavigationItem < NavigationItem
  PLATFORMS = [ "Bluesky", "Email", "Facebook", "Foto", "GitHub", "Glass", "Hipstamatic", "Instagram", "LinkedIn", "Mastodon",
                "Pixelfed", "Reddit", "RSS", "Spotify", "Threads", "TikTok", "Web", "X", "YouTube" ].sort
